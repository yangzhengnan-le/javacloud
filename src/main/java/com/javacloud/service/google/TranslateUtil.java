 ...
 */
package com.javacloud.service.google;
...
public class TranslateUtil {
	...
	public static String translate(final String text, final String src_lang, final String target_lang)
		...
		Document doc = null;
		Element ele = null;
        final String query=text.replace(" ", "%20");
        try {
			// create URL string
			...
			is = HttpClientUtil.downloadAsStream("https://translate.google.cn/?text="+query);
...
//                URLEncoder.encode(text, ENCODING));
    ...
    {
        try {
            System.out.println(TranslateUtil.translate("how beautiful are you","en","zh-cn"));
        } catch (Exception e) {
            e.printStackTrace();
        }
